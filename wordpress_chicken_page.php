<?php
/*
Template Name: 雞排結帳系統
*/
get_header(); ?>

<div class="chicken-system-container">
    <div class="chicken-system-header">
        <h1>🍗 雞排結帳系統</h1>
        <p>整合到 WordPress 的雞排對帳系統</p>
    </div>
    
    <div class="chicken-system-content">
        ...
        <div class="info-grid">
            ...
            <div class="info-card">
                ...
                <ul>
                    ...
                    <li><strong>主機:</strong> A2 Hosting</li>
                    <li><strong>網域:</strong> <?php echo home_url(); ?></li>
                    <li><strong>狀態:</strong> 已整合</li>
                </ul>
            </div>
        ...
        <div class="action-buttons">
            <a href="http://localhost:8082" target="_blank" class="btn btn-success">🚀 開啟完整系統</a>
            <a href="javascript:void(0)" onclick="showFeatures()" class="btn btn-primary">🔍 查看功能詳情</a>
        </div>
    </div>
</div>

<style>
.chicken-system-container {
    max-width: 1000px;
    margin: 0 auto;
    padding: 20px;
